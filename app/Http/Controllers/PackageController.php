...
class PackageController extends Controller {
    ...
    public function store(Request $request) {
        ...
        if ($request->dedicated_marriage_counselor != null) {
            $package->dedicated_marriage_counselor = 1;
        } else {
            $package->dedicated_marriage_counselor = 0;
        }
        if ($request->offline_resume_managed != null) {
            $package->offline_resume_managed = 1;
        } else {
            $package->offline_resume_managed = 0;
        }
