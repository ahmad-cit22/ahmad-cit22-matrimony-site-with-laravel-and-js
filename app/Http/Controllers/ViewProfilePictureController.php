    ...
    public function store(Request $request)
    {
        ...
        if ($view_profile_picture->save()) {
            ...
            try {
                ...
                $message       = $auth_user->user_id . ' ' . translate(' wants to see your profile picture.');
    ...
    public function accept_request(Request $request)
    {
        ...
        if ($view_profile_picture->save()) {
            ...
            try {
                ...
                $notify_by = $auth_user->id;
                $info_id = $view_profile_picture->id;
                $message = $auth_user->user_id . ' ' . translate(' has accepted your profile picture view request.');
    ...
    public function reject_request(Request $request)
    {
        ...
        if (ViewProfilePicture::destroy($request->profile_pic_view_request_id)) {
            ...
            try {
                ...
                $message = $auth_user->user_id . ' ' . translate(' has rejected your profile picture view request.');
