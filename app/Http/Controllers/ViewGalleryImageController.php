    ...
    public function store(Request $request)
    {
        ...
        if ($view_gallert_image->save()) {
            ...
            try {
                ...
                $message       = $auth_user->user_id . ' ' . translate(' wants to see your gallery images.');
    ...
    public function accept_request(Request $request)
    {
        ...
        if ($view_gallery_image->save()) {
            ...
            try {
                ...
                $message = $auth_user->user_id . ' ' . translate(' has accepted your gallery image view request.');
    ...
    public function reject_request(Request $request)
    {
        ...
        if (ViewGalleryImage::destroy($request->gallery_image_view_request_id)) {
            ...
            try {
                ...
                $message = $auth_user->user_id . ' ' . translate(' has rejected your gallery image view request.');
                $route = route("member_profile", $auth_user->id);
