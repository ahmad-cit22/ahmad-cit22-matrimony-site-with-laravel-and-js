...
// our team
Route::get('/dashboard/our-team/list', [TeamMemberController::class, 'index'])->name('admin.our_team.index');
Route::post('/dashboard/our-team/member-add', [TeamMemberController::class, 'member_add'])->name('admin.member.add');
