                ...
                <div class="logo mb-4">
                    <a href="{{ route('home') }}" class="d-inline-block py-15px">
                        @if (get_setting('footer_logo') != null)
                            <img src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-40px h-md-70px" height="60">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-50px" height="40">
                        @endif
                    </a>
                </div>
