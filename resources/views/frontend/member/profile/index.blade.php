...
@section('panel_content')
        ...
        <div class="card-body">
            <form action="{{ route('member.introduction.update', $member->member->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea type="text" name="introduction" class="form-control" rows="4" placeholder="{{ translate('Introduction (Briefly describe about your personality, viewpoint, hobbies etc.)') }}" required>{{ $member->member->introduction }}</textarea>
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('user.change.email', $member->member->user_id) }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-2">
