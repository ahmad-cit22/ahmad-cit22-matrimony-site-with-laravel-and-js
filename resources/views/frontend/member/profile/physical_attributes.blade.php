      ...
      <form action="{{ route('physical-attribute.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  ...
                  <input type="number" name="height" value="{{ !empty($member->physical_attributes->height) ? $member->physical_attributes->height : "" }}" step="any" class="form-control" placeholder="{{translate('Height')}}" >
                  @error('height')
