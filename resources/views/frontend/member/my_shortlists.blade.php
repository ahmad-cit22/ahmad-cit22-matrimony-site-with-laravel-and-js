                    ...
                    @foreach ($shortlists as $key => $shortlist)
                        @if ($shortlist->user != null)
                            <tr id="shortlisted_member_{{ $shortlist->user_id }}">
                              ...
                              @else
                                  href="{{ route('member_profile', $shortlist->user_id) }}" @endif class="text-reset c-pointer">
                                    ...
                                    <td>
                                        @php
                                            $present_address = \App\Models\Address::where('type', 'present')
                                                ->where('user_id', $shortlist->user_id)
                                                ->first();
                                        @endphp
                                ...
                                <td class="text-right">
                                    @php
                                        $interest = \App\Models\ExpressInterest::where('user_id', $shortlist->user_id)
