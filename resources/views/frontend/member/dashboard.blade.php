            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-raw fs-15 mb-4 pb-4 border-bottom">
                        ...
                        <li class="list-group-item py-2 text-line-through">
                            @if ($user->member->package->dedicated_marriage_counselor == 0)
                                <i class="las la-times text-danger mr-2"></i>
                        ...
                        <li class="list-group-item py-2 text-line-through">
                            @if ($user->member->package->offline_resume_managed == 0)
                                <i class="las la-times text-danger mr-2"></i>
                            ...
                            @forelse ($similar_profiles->shuffle()->take(5) as $similar_profile)
                                @if ($similar_profile->user != null)
                                    <a href="{{ route('member_profile', $similar_profile->match_id) }}" class="text-reset border rounded row no-gutters align-items-center mb-3">
                                      ...
                                      @else
                                      src="{{ static_asset($avatar_image) }}" @endif onerror="this.onerror=null;this.src='{{ static_asset($avatar_image) }}';" class="img-fit w-100 size-100px">
                                        </div>
                                        <div class="col">
                                            <div class="p-3">
                                                <h5 class="fs-16 text-body text-truncate">{{ $similar_profile->user->user_id }}</h5>
