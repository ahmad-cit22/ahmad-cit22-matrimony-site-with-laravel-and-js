            ...
            <div class="row">
                    ...
                    <div class="aiz-profile-sidebar">
                        <div class="overflow-hidden position-relative rounded shadow-lg mb-4 bg-white d-none d-xl-block">
                            ...
                            @if ($user->photo != null && $user->photo_approved == 1 && $profile_pic_privacy == 'only_me' && ($photo_view_request == null || ($photo_view_request && $photo_view_request->status == 0)))
                                <button @if ($photo_view_request == null) onclick="profile_pic_view_request({{ $user->id }})" @endif class="btn btn-block btn-primary position-relative z-1">
                        ...
                        <div class="mb-4 p-4 border rounded border-gray-200 d-none d-xl-block">
                            ...
                            <h2 class="fs-20 fw-500">{{ $user->user_id }}</h2>
                            ...
                            @if (Auth::user()->id != $user->id)
                                <div class="mb-2 mt-4">
                                    ...
                                    @endphp
                                    <a href="avascript:void(0);" id="shortlist_a_id_{{ $user->id }}" @if ($shortlist_onclick == 1) onclick="do_shortlist({{ $user->id }})"
                                    @else
                                        onclick="remove_shortlist({{ $user->id }})" @endif class="btn btn-block btn-primary text-left">
                                ...
                                <div class="row gutters-5">
                                    ...
                                    <div class="col">
                                        ...
                                        @endphp
                                        <a href="avascript:void(0);" id="report_a_id_{{ $user->id }}" @if ($report_onclick == 1) onclick="report_member({{ $user->id }})" @endif class="btn btn-block btn-primary text-left">
                                        ...
                                        @if ($similar_profile->user != null)
                                            <a href="{{ route('member_profile', $similar_profile->match_id) }}" class="text-reset border rounded row no-gutters align-items-center mb-3">
                                                <div class="col-auto w-120px">
                                                    ...
                                                    @else
                                                    src="{{ static_asset($avatar_image) }}" @endif onerror="this.onerror=null;this.src='{{ static_asset($avatar_image) }}';" class="img-fit w-100 size-120px">
                                                </div>
                                                <div class="col">
                                                    <div class="p-3">
                                                        <h5 class="fs-16 text-body text-truncate">
                                                            {{ $similar_profile->user->user_id }}
                                                        </h5>
                ...
                <div class="col-xl-8 offset-xxl-1">
                    ...
                    <div class="mb-4 p-4 border rounded border-gray-200 d-xl-none">
                        ...
                        <h2 class="fs-20 fw-500 mb-4">{{ $user->user_id }}</h2>
                        ...
                        <div class="tab-pane fade show active" id="profile">
                            ...
                            <div class="accordion aiz-timeline-accordion" id="profile-accordion">
                                ...
                                <div class="pb-4 accordion-item">
                                    <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#about" aria-expanded="true">
                                        <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22.034" height="16.525" viewBox="0 0 22.034 16.525" class="fill-primary-grad">
                                        ...
                                        <div class="ml-4">
                                            <span class="fs-18 fw-600 d-block">{{ translate('About ') }}{{ $user->user_id }}</span>
                                            <span class="fs-11 fw-400">
                                                <span>{{ translate('Member ID: ') }} {{ $user->code }}</span>
                                                <span class="mx-2">|</span>
                                                <span>{{ translate('On Behalf Of:') }}
                                                    {{ $user->member->on_behalves->name }}</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div id="about" class="collapse show accordion-body ml-3 ml-md-5 pl-25px lh-1-8" data-parent="#profile-accordion">
                                ...
                                <!-- basic information -->
                                <div class="pb-4 accordion-item">
                                    <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#basic-info">
                                        <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                    ...
                                    <div id="basic-info" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-sm-6">
                                                    <table class="w-100">
                                                        <tbody>
                                                            <tr>
                                                                <td class="py-1 fw-600">{{ translate('User ID') }}
                                                                </td>
                                                                <td class="py-1">{{ $user->user_id }}</td>
                                                            </tr>
                                                            <tr>
                                ...
                                @if (get_setting('member_present_address_section') == 'on')
                                    <!-- Present Address -->
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#present-address">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24.017" height="24.064" viewBox="0 0 24.017 24.064" class="fill-primary-grad">
                                                    <g transform="translate(-1078.993 -1084.468)">
                                                        ...
                                                        <path
                                                            ...
                                                            transform="translate(1078.992 1084.467)" fill="url(#primary-gradient)" />
                                                    </g>
                                                </svg>
                                            </span>
                                            <div class="ml-4">
                                        ...
                                        <div id="present-address" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="border p-3">
                                                        <table class="w-100">
                                ...
                                <!-- Contact Details -->
                                <div class="pb-4 accordion-item">
                                    <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#contact-details">
                                        <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                    ...
                                    <div id="contact-details" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="border p-3">
                                                    @if (Auth::user()->id != $user->id)
                                                        ...
                                                        @if (empty($view_contact))
                                                            <a onclick="view_contact({{ $user->id }})" class="btn btn-block bg-primary text-white mt-2 view_contact">
                                ...
                                @if (get_setting('member_education_section') == 'on')
                                    <!-- Education -->
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#education">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        ...
                                        <div id="education" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                ...
                                @if (get_setting('member_career_section') == 'on')
                                    <!-- Career -->
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#career">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        ...
                                        <div id="career" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                ...
                                @if (get_setting('member_physical_attributes_section') == 'on')
                                    <!-- Physical Attributes -->
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#physical-attributes">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        ...
                                        <div id="physical-attributes" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                            <div class="border p-3">
                                                <div class="row no-gutters">
                                                    <div class="col-sm-6">
                                                        <table class="w-100">
                                ...
                                @if (get_setting('member_language_section') == 'on')
                                    <!-- Language -->
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#language">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        ...
                                        <div id="language" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="border p-3">
                                                        <table class="w-100">
                                ...
                                @if (get_setting('member_hobbies_and_interests_section') == 'on')
                                    <!-- Hobbies & Interest  -->
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#hobby">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        ...
                                        <div id="hobby" class="collapse accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                            <div class="border p-3">
                                                <div class="row no-gutters">
                                                    <div class="col-md-6">
                                                        <table class="w-100">
                                ...
                                @if (get_setting('member_personal_attitude_and_behavior_section') == 'on')
                                    ...
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#personal-attitude">
                                            <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28.394" height="27.785" viewBox="0 0 28.394 27.785" class="fill-primary-grad">
                                                    <g transform="translate(-1076.803 -2260.108)">
                                                        <path
                                                            ...
                                                            transform="translate(1076.803 2260.108)" fill="url(#primary-gradient)" />
                                                        <path
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24.659" height="19.623" viewBox="0 0 24.659 19.623" class="fill-primary-grad">
                                                    <g transform="translate(-1078.67 -2909.649)">
                                                        <path
                                                            ...
                                                            transform="translate(988.781 2656.649)" fill="url(#primary-gradient)" />
                                                        <path d="M114.439,263.248l-.948,1.132a.52.52,0,0,1-.321.168h-.046a.47.47,0,0,1-.321-.107l-10.584-8.825-10.584,8.825a.569.569,0,0,1-.367.107.52.52,0,0,1-.321-.168L90,263.248a.5.5,0,0,1-.107-.359.444.444,0,0,1,.168-.329l11-9.162a1.9,1.9,0,0,1,2.325,0l3.732,3.12v-2.983a.471.471,0,0,1,.489-.489h2.937a.471.471,0,0,1,.489.489v6.24l3.35,2.784a.444.444,0,0,1,.168.329A.5.5,0,0,1,114.439,263.248Z" transform="translate(988.781 2656.649)"
                                                            class="fill-dark" />
                                                    </g>
                                                </svg>
                                            </span>
                            ...
                            <div class="card-columns position-relative">
                                ...
                                @foreach ($gallery_images as $gallery_image)
                                    <div class="card hov-overlay">
                                        @if ($gallery_image_show)
                                            <img src="{{ uploaded_asset($gallery_image->image) }}" class="card-img" alt="{{ translate('photo') }}">
                                            <div class="overlay">
                                                <a target="_blank" href="{{ uploaded_asset($gallery_image->image) }}" class="text-white absolute-full d-flex justify-content-center align-items-center" title="View">
                                                    <i class="las la-search-plus la-2x"></i>
                                                </a>
                                            </div>
                                        @else
                                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" class="card-img" alt="{{ translate('photo') }}">
                                            <div class="absolute-full d-flex justify-content-center align-items-center bg-soft-dark text-white"><i class="las la-lock la-3x"></i></div>
                                        @endif
                                    </div>
                                @endforeach
                                ...
                                @if (count($gallery_images) > 0 && $gallery_image_privacy == 'only_me' && ($gallery_photo_view_request == null || ($gallery_photo_view_request && $gallery_photo_view_request->status == 0)))
                                    <div class="absolute-full d-flex justify-content-center align-items-center">
                                        <button @if ($gallery_photo_view_request == null) onclick="gallery_image_view_request({{ $user->id }})" @endif class="btn btn-primary">
