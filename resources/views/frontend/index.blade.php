                        ...
                        <div class="offset-xxl-2 offset-xl-1 col-lg-6 col-xxl-5">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label class="form-label" for="on_behalf">{{ translate('On Behalf Of') }}</label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label class="form-label" for="name">{{ translate('User ID') }}</label>
                                                    <input type="text" class="form-control @error('user_id') is-invalid @enderror" name="user_id" id="user_id" placeholder="{{ translate('Create user ID (Ex: jack123)') }}" required>
                                                    @error('user_id')
                                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control aiz-date-range @error('date_of_birth') is-invalid @enderror" name="date_of_birth" id="date_of_birth" placeholder="{{ translate('Date Of Birth') }}" data-single="true" data-show-dropdown="true" data-max-date="{{ get_max_date() }}" autocomplete="off">
                                                    @error('date_of_birth')
                                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="">
                                        <button type="submit" id="reg-submit-btn" class="btn btn-block btn-primary">{{ translate('Create Account') }}</button>
                                    </div>
                            ...
                            <div class="overflow-hidden shadow-none mb-3 border-right">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-raw fs-15 mb-5">
                                        ...
                                        <li class="list-group-item py-2 text-line-through">
                                            @if ($package->dedicated_marriage_counselor == 0)
                                                <i class="las la-times text-danger mr-2"></i>
                                                <del class="opacity-60">{{ translate('Dedicated Marriage Counselor Support from Us') }}</del>
                                            @else
                                                <i class="las la-check text-success mr-2"></i>
                                                {{ translate('Dedicated Marriage Counselor Support from Us') }}
                                            @endif
                                        </li>
                                        <li class="list-group-item py-2 text-line-through">
                                            @if ($package->offline_resume_managed == 0)
                                                <i class="las la-times text-danger mr-2"></i>
                                                <del class="opacity-60">{{ translate('Offline Resume Managed by Us') }}</del>
                                            @else
                                                <i class="las la-check text-success mr-2"></i>
                                                {{ translate('Offline Resume Managed by Us') }}
                                            @endif
                                        </li>
                                    </ul>
    ...
    @if (get_setting('show_blog_section') == 'on')
        <section class="py-7 bg-white text-white">
            <div class="container">
                ...
                <div class="aiz-carousel gutters-10" data-items="4" data-xl-items="3" data-md-items="2" data-sm-items="1" data-arrows='true'>
                    @php
