                        ...
                        <div class="card-body">
                            ...
                            <form class="form-default" id="reg-form" role="form" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="user_id">{{ translate('User ID') }}</label>
                                            <input type="text" class="form-control @error('user_id') is-invalid @enderror" name="user_id" id="user_id" placeholder="{{ translate('Create a unique user ID (Ex: jack123)') }}" required>
                                            @error('user_id')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control aiz-selectpicker @error('gender') is-invalid @enderror" name="gender" required>
                                                ...
                                                <option value="3">{{ translate("Won't Share") }}</option>
                                            </select>
                                            @error('gender')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <small>{{ translate('Minimun 8 alphanumeric characters needed') }}</small>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
