    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                @hasrole([1])
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('admin.our_team.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['happy-story.edit', 'happy-story.show']) }}">
                            <i class="las la-handshake aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Our Team') }}</span>
                        </a>
                    </li>
                ...
                @can('show_contact_us_queries')
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('contact-us.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['contact-us.index', 'contact-us.show']) }}">
