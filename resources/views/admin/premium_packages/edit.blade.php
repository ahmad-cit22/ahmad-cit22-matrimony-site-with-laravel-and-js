                ...
                <div class="card-body">
                    <form action="{{ route('packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="express_interest" value="{{ $package->express_interest }}" class="form-control" placeholder="{{ translate('e.g. 10') }}" min="0" required>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Gallery Photo Upload') }}</label>
                            <div class="col-md-9">
                                <input type="text" name="photo_gallery" value="{{ $package->photo_gallery }}" class="form-control" placeholder="{{ translate('e.g. 10') }}" required>
                                @error('photo_gallery')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="contact" value="{{ $package->contact }}" class="form-control" placeholder="{{ translate('e.g. 10') }}" required>
                                @error('contact')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Dedicated Marriage Counselor Support from Us') }}</label>
                            <div class="col-md-8 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="dedicated_marriage_counselor" @if ($package->dedicated_marriage_counselor == '1') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Offline Resume Managed by Us') }}</label>
                            <div class="col-md-8 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="offline_resume_managed" @if ($package->offline_resume_managed == '1') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                @if (get_setting('profile_picture_privacy') == 'only_me')
                                    <input type="number" name="profile_image_view" value="{{ $package->profile_image_view }}" id="profile_image_view" class="form-control" placeholder="{{ translate('e.g. 10') }}" required>
                                @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                @if (get_setting('gallery_image_privacy') == 'only_me')
                                    <input type="number" name="gallery_image_view" value="{{ $package->gallery_image_view }}" id="gallery_image_view" class="form-control" placeholder="{{ translate('e.g. 10') }}" required>
                                @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="number" name="validity" value="{{ $package->validity }}" class="form-control" placeholder="{{ translate('e.g. 30') }}" min="0" required>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Make Popular') }}</label>
                            <div class="col-md-8 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="is_popular" @if ($package->is_popular == '1') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
