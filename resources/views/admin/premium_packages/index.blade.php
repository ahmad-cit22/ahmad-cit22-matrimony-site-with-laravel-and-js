                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" id="status.{{ $key }}" onchange="update_package_activation_status(this)" value="{{ $package->id }}" @if ($package->active == 1) checked @endif data-switch="success"/ @if (auth()->user()->cannot('edit_package')) disabled @endif>
                                            <span></span>
                                        </label>
                                    </td>
                                    <td class="text-right">
