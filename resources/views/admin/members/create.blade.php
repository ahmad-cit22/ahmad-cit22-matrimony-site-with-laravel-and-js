                ...
                <div class="card-body">
                    <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{translate('User ID')}}<span class="text-danger"> *</span></label>
                            <div class="col-md-9">
                                <input type="text" name="user_id" class="form-control" placeholder="{{translate('User ID')}}" required>
                                @error('user_id')
