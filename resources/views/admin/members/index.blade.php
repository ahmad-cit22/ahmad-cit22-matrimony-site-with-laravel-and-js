                    ...
                    <div class="col-md-3">
                        <form class="" id="sort_members" action="" method="GET">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" id="search" name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="{{ translate('Type User/Member ID & Enter') }}">
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <table class="table aiz-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th data-breakpoints="md">{{ translate('User ID') }}</th>
