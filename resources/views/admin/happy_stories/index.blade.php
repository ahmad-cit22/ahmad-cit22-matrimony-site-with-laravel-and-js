                        ...
                        <tr>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input onchange="update_status(this)" value="{{ $happy_story->id }}" type="checkbox" @if ($happy_story->approved == 1) checked @endif @if (auth()->user()->cannot('approve_happy_story')) disabled @endif>
...
@section('script')
    <script>
        ...
        function update_status(el) {
            ...
            $.post('{{ route('happy_story_approval.status') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
